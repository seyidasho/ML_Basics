...
•	Anomaly detection refers to identifying rare items, events or observations that are significantly different from the majority of the data. These outliers or anomalies may be indicative of some issue or abnormal behavior.<br>
•	Goal is to detect anomalies with high accuracy while minimizing false positives.<br>
•	Applications include fraud detection, network intrusion, breakdown detection in manufacturing, etc.<br>
**Common approaches:** <br>
o	Statistical methods: Declare points outliers if they are far from mean/median or in the tails of a distribution.<br>
o	Distance-based: Find points with low nearest neighbor density as outliers.<br>
o	Classification-based: Train binary classifiers to distinguish between normal and outlier classes.<br>
o	Clustering: Identify small clusters or points far from clusters as anomalous.<br>
